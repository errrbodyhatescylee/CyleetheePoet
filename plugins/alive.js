...
smd(
  ...
  async (message) => {
    const owner = "Chucky 2.0"; // Owner name
    const footer = "=== |🧸| Powered by chuckyXcylee |🧸| === ";
...
*Made With Love by chuckyXcylee ❄️❤️🧸*
...
smd({
  ...
  async (message) => {
    ...
    const name = "*Sir Cylee ❤️🧸*";
    
    const footer = "*=== |🧸| Powered by Chucky 2.0|🧸| ===*";
